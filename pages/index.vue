                                ...
                                <div class="col-sm-6 col-lg-6">
                                    <div class="col-lg-12 p-0">
                                        <div class="choose-item">
                                            ...
                                            <h3>ما به شما خدمات با کیفیتی ارائه می دهیم</h3>
                                    ...
                                    <div class="col-lg-12 p-0">
                                        <div class="choose-item">
                                            ...
                                            <h3>پاسخ سریع و پشتیبانی 24/7</h3>
                                            <p>لورم ایپسوم ساختار چاپ و متن را در بر می گیرد. لورم ایپسوم استاندارد صنعت بوده است.</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="choose-contact">
                            <div class="section-title">
                                ...
                                <h2>شرکت خدمات نظافتی مجاز بیش از 15 سال تجربه</h2>
                            </div>
                            ...
                            <a class="cmn-btn" href="contact.html">تماس با ما</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about-img">
                            ...
                            <div class="video-wrap">
                                <a href="https://www.youtube.com/watch?v=Dviu-D3Fijo" class="popup-youtube">

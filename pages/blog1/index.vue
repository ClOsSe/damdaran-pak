                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            <a href="#" class="nav-link dropdown-toggle">کاربران <i class='bx bx-chevron-down'></i></a>
                                            <ul class="dropdown-menu">
                                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link dropdown-toggle active">وبلاگ <i class='bx bx-chevron-down'></i></a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="blog-item">
                            <a href="blog-details.html">
                                <img src="assets/img/home-three/blog4.jpg" alt="Blog">
                            </a>
                            <div class="blog-bottom">
                                <h3>
                                    <a href="blog-details.html">آموزش نحوه رزرو آسان خدمات نظافتی شرکت لیکسی</a>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="blog-item">
                            <a href="blog-details.html">
                                <img src="assets/img/home-three/blog5.jpg" alt="Blog">
                            </a>
                            <div class="blog-bottom">
                                <h3>
                                    <a href="blog-details.html">آموزش نحوه رزرو آسان خدمات نظافتی شرکت لیکسی</a>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="blog-item">
                            <a href="blog-details.html">
                                <img src="assets/img/home-three/blog6.jpg" alt="Blog">
                            </a>
                            <div class="blog-bottom">
                                <h3>
                                    <a href="blog-details.html">آموزش نحوه رزرو آسان خدمات نظافتی شرکت لیکسی</a>
